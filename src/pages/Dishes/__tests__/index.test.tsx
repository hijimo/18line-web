...
let DishesPage: React.ComponentType;
try {
  DishesPage = require('@/pages/Dishes/index').default;
} catch {
  DishesPage = null;
}
...
const describeIfComponentExists = DishesPage ? describe : describe.skip;

describeIfComponentExists('菜品管理 (Dishes) Page', () => {
  beforeEach(() => {
    render(<DishesPage />);
  });
