...
const edit5 = (
  ...
  const getInfo25 = (
    { postId }: GetInfo25PathParameters,
 ) => {
      return orvalMutator<AjaxResult>(
  ...
  return {edit5,add6,export11,getInfo25,optionselect1,list26,remove17}};
...
export type GetInfo25Result = NonNullable<Awaited<ReturnType<ReturnType<typeof getSysPostController>['getInfo25']>>>
export type Optionselect1Result = NonNullable<Awaited<ReturnType<ReturnType<typeof getSysPostController>['optionselect1']>>>
export type List26Result = NonNullable<Awaited<ReturnType<ReturnType<typeof getSysPostController>['list26']>>>
