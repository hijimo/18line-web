...
export const getSysOperlogController = () => {
  ...
  const remove23 = ({ operIds }: Remove23PathParameters) => {
...
export type Export14Result = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getSysOperlogController>['export14']>>
>;
export type List24Result = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getSysOperlogController>['list24']>>
>;
export type Remove23Result = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getSysOperlogController>['remove23']>>
>;
