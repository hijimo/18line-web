 ...
 */
import type { AjaxResult, UpdateProfile1Params, UpdatePwdBody } from '../../../types/api';
...
export const get = () => {
   ...
   * @summary 修改用户
   */
  const updateProfile1 = (params?: UpdateProfile1Params) => {
    return orvalMutator<AjaxResult>({ url: `/system/user/profile`, method: 'PUT', params });
  };
  /**
   * @summary 重置密码
   */
   ...
   */
  const avatar = () => {
    return orvalMutator<AjaxResult>({ url: `/system/user/profile/avatar`, method: 'POST' });
  };
