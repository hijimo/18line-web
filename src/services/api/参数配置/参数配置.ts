 ...
 */
const getInfo31 = (
    { configId }: GetInfo31PathParameters,
 ) => {
      return orvalMutator<AjaxResult>(
...
const refreshCache2 = (
  ...
  return {edit11,add12,export14,getInfo31,list32,getConfigKey,remove23,refreshCache2}};
...
export type GetInfo31Result = NonNullable<Awaited<ReturnType<ReturnType<typeof get>['getInfo31']>>>
export type List32Result = NonNullable<Awaited<ReturnType<ReturnType<typeof get>['list32']>>>
