...
export const getSysDeptController = () => {
  const edit10 = (params?: Edit10Params) => {
    return orvalMutator<AjaxResult>({ url: `/system/dept`, method: 'PUT', params });
  };
  const add10 = (params?: Add10Params) => {
    return orvalMutator<AjaxResult>({ url: `/system/dept`, method: 'POST', params });
  };
  ...
  const getInfo22 = ({ deptId }: GetInfo22PathParameters) => {
    return orvalMutator<AjaxResult>({ url: `/system/dept/${deptId}`, method: 'GET' });
  };
  const remove21 = ({ deptId }: Remove21PathParameters) => {
...
>;
export type Add10Result = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getSysDeptController>['add10']>>
>;
export type UpdateSort1Result = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getSysDeptController>['updateSort1']>>
>;
export type GetInfo22Result = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getSysDeptController>['getInfo22']>>
>;
export type Remove21Result = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getSysDeptController>['remove21']>>
>;
export type List22Result = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getSysDeptController>['list22']>>
>;
