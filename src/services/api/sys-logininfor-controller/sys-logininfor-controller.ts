...
export const getSysLogininforController = () => {
  ...
  const remove24 = ({ infoIds }: Remove24PathParameters) => {
...
export type Export15Result = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getSysLogininforController>['export15']>>
>;
export type UnlockResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getSysLogininforController>['unlock']>>
>;
export type List26Result = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getSysLogininforController>['list26']>>
>;
export type Remove24Result = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getSysLogininforController>['remove24']>>
>;
