 ...
 */
const getInfo27 = (
    { menuId }: GetInfo27PathParameters,
 ) => {
      return orvalMutator<AjaxResult>(
...
const list28 = (
  ...
  return {edit7,add8,updateSort,getInfo27,remove19,treeselect,roleMenuTreeselect,list28}};
...
export type List28Result = NonNullable<Awaited<ReturnType<ReturnType<typeof get>['list28']>>>
