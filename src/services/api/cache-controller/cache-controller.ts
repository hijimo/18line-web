...
const getInfo33 = (
  ...
  return {getInfo33,getCacheValue,cache,getCacheKeys,clearCacheName,clearCacheKey,clearCacheAll}};
export type GetInfo33Result = NonNullable<Awaited<ReturnType<ReturnType<typeof getCacheController>['getInfo33']>>>
